...
speakeasy: check-speakeasy
	speakeasy generate sdk --lang java -o . -s ./openapi.json

speakeasy-validate: check-speakeasy
	speakeasy validate openapi -s ./openapi.json

openapi:
	curl https://raw.githubusercontent.com/OAI/OpenAPI-Specification/main/examples/v2.0/json/petstore-separate/spec/swagger.json > ./openapi.json
